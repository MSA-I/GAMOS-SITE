    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          inset: 0,
          zIndex: 50,
          // rooms-lab EXPERIMENT: the door→gallery handoff is now LIT, not black.
          // Colour sampled from the door clip's LAST frame (the lit doorway),
          // matching the door page's .lit-veil so this cover fades in from the
          // same tone the door opened onto. (Production IntroGate = ink-deep.)
          background: "#dda86b",
