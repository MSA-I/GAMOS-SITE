...
**בלי לגעת בקוד הפרודקשן**. אם המשתמש יאשר — ממזגים לאתר (ראה _Merge checklist_).
...
- סקשן `.door-scene` עם sticky 100vh על spacer של 800vh (איטי וחלק) — **תוך כדי גלילה הדלת
