...
const PAIRS = [
  ...
  // #events mouse-distortion gallery (2026-07-13 v2: name-only rows; the
  // full detail lives in each row's aria-label). "סוגי אירועים" doubles as
  // the nav label since the nav swap — keep the translation nav-short.
