...
const PAIRS = [
  ...
  // #events hover-list gallery (2026-07-13: replaced the accordion)
  // Short enough for the nowrap nav link (it doubles as the nav label since
  // the 2026-07-13 nav swap) while still dignified as the section headline.
  ["סוגי אירועים", "Celebrations", "Célébrations"],
  ["חתונות", "Weddings", "Mariages"],
  ["באולם, בגן או במתחם כולו", "In the hall, the garden or the entire estate", "Dans la salle, au jardin ou dans tout le domaine"],
  ["ליווי אישי", "Personal Guidance", "Accompagnement personnalisé"],
  ["עד 1000 מוזמנים", "Up to 1000 guests", "Jusqu'à 1000 invités"],
  ["חתונות — באולם, בגן או במתחם כולו, עד 1000 מוזמנים — לתיאום סיור", "Weddings — in the hall, the garden or the entire estate, up to 1000 guests — book a tour", "Mariages — dans la salle, au jardin ou dans tout le domaine, jusqu'à 1000 invités — réserver une visite"],
  ["בר ובת מצווה", "Bar & Bat Mitzvah", "Bar et Bat Mitzvah"],
  ["חגיגה שמרגשת את כל הדורות", "A celebration that moves every generation", "Une fête qui émeut toutes les générations"],
  ["תוכן ואטרקציות", "Programming & Attractions", "Animations et attractions"],
  ["מתחמים מותאמים", "Dedicated Spaces", "Espaces dédiés"],
  ["בר ובת מצווה — חגיגה שמרגשת את כל הדורות, תוכן ואטרקציות — לתיאום סיור", "Bar & Bat Mitzvah — a celebration that moves every generation, programming and attractions — book a tour", "Bar et Bat Mitzvah — une fête qui émeut toutes les générations, animations et attractions — réserver une visite"],
  ["ברית ובריתה", "Brit & Britah", "Brit et Brita"],
  ["אירוע משפחתי באווירה אלגנטית", "A family event in an elegant atmosphere", "Un événement familial dans une atmosphère élégante"],
  ["אירוח מוקפד", "Meticulous Hospitality", "Accueil soigné"],
  ["קולינריה איכותית", "Quality Cuisine", "Cuisine de qualité"],
  ["ברית ובריתה — אירוע משפחתי באווירה אלגנטית, קולינריה איכותית — לתיאום סיור", "Brit & Britah — a family event in an elegant atmosphere, quality cuisine — book a tour", "Brit et Brita — un événement familial dans une atmosphère élégante, cuisine de qualité — réserver une visite"],
  ["אירועי חברה", "Corporate Events", "Événements d'entreprise"],
  ["כנסים, השקות וערבי גיבוש", "Conferences, launches & team evenings", "Conférences, lancements et soirées de cohésion"],
  ["הפקה מלאה", "Full Production", "Production complète"],
  ["פתרונות מותאמים", "Tailored Solutions", "Solutions sur mesure"],
  ["אירועי חברה — כנסים, השקות וערבי גיבוש, הפקה מלאה — לתיאום סיור", "Corporate events — conferences, launches and team evenings, full production — book a tour", "Événements d'entreprise — conférences, lancements et soirées de cohésion, production complète — réserver une visite"],
  ["אירועים פרטיים", "Private Events", "Événements privés"],
  ["ימי הולדת וחגיגות משפחתיות", "Birthdays & family celebrations", "Anniversaires et fêtes de famille"],
  ["במה מרשימה", "An Impressive Stage", "Une scène remarquable"],
  ["כל קונספט", "Any Concept", "Tout concept"],
  ["אירועים פרטיים — ימי הולדת וחגיגות משפחתיות, במה מרשימה — לתיאום סיור", "Private events — birthdays and family celebrations, an impressive stage — book a tour", "Événements privés — anniversaires et fêtes de famille, une scène remarquable — réserver une visite"],
  ["המתחם כולו שמור רק לכם", "The entire estate reserved just for you", "Tout le domaine réservé rien qu'à vous"],
  ["סוויטות ובריכה", "Suites & Pool", "Suites et piscine"],
  ["סוף שבוע מלא", "A Full Weekend", "Un week-end entier"],
  ["שבתות חתן — המתחם כולו שמור רק לכם, סוויטות ובריכה, סוף שבוע מלא — לתיאום סיור", "Groom's Shabbat — the entire estate reserved just for you, suites and pool, a full weekend — book a tour", "Shabbat du marié — tout le domaine réservé rien qu'à vous, suites et piscine, un week-end entier — réserver une visite"],
