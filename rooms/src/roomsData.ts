...
const PLACEHOLDER_BODY: Record<RoomCategory, string> = {
  ...
  "סוויטת חתן כלה": "תצלום נוסף של הסוויטה יתווסף בקרוב — מרחב יוקרתי ומעוצב לאורחי הכבוד.",
...
const REAL_BY_CATEGORY: Record<RoomCategory, RealSlot[]> = {
  ...
  "סוויטת חתן כלה": [
    ...
    { imageNo: "12", titleHe: "הסוויטה במבט מלא", body: "חלל רחב, מואר ומאוזן המעניק שילוב מושלם בין נוחות, פרטיות ואלגנטיות." },
    ...
    { imageNo: "14", titleHe: "מקלחת הגשם", body: "מקלחת גשם מפנקת בעיצוב שיש כהה וגווני פליז, המעניקה רגע של רעננות והתחדשות בין שלבי האירוע." },
