...
const EN: Record<string, string> = {
  ...
  "סוויטת חתן כלה": "Bride & Groom Suite",
  "חתן כלה": "Bride & Groom",
  "חדר נוף": "View Room",
  ...
  "מקלחת גשם מפנקת בעיצוב שיש כהה וגווני פליז, המעניקה רגע של רעננות והתחדשות בין שלבי האירוע.": "An indulgent rain shower in dark marble and brass tones, offering a moment of freshness and renewal between the moments of the day.",
...
const FR: Record<string, string> = {
  ...
  "סוויטת חתן כלה": "Suite des Mariés",
  "חתן כלה": "Mariés",
  ...
  "סוויטת הכלה": "La Suite de la Mariée",
  ...
  "מקלחת גשם מפנקת בעיצוב שיש כהה וגווני פליז, המעניקה רגע של רעננות והתחדשות בין שלבי האירוע.": "Une douche de pluie raffinée, en marbre foncé et tons laiton, offrant un instant de fraîcheur et de ressourcement entre les temps forts de la journée.",
